<header class="flex items-center gap-[15%]">
    ...
    <nav class="flex justify-between w-full">
        ...
        <ul class="flex gap-20 font-semibold">
            ...
            @auth
                <li class="hover:underline"><a href="{{route('inventory')}}" class="text-emerald-600">Inventario</a></li>
                <li class="hover:underline"><a href="{{route('products.index')}}" class="text-emerald-600">Dashboard</a></li>
